  ...
  return (
    <footer className="bg-wine-900 text-white py-16 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-12">
        ...
        <div>
          <h4 className="font-bold mb-6 text-gold-400 font-display">Product</h4>
        ...
        <div>
          <h4 className="font-bold mb-6 text-gold-400 font-display">Company</h4>
          <ul className="space-y-4 text-sm text-white/70">
        ...
        <div>
          <h4 className="font-bold mb-6 text-gold-400 font-display">Support</h4>
